...
CLIENT_HOSTNAMES="${GEN_HOSTS_CLIENT},${GEN_ACCESS_SERVICE_NAME},${GEN_ACCESS_SERVICE_NAME}.${GEN_NAMESPACE},${GEN_ACCESS_SERVICE_NAME}.${GEN_NAMESPACE}.svc.${GEN_CLUSTER_DOMAIN}"
